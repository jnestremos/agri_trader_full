        ...
        <form @submit.prevent="sendExpenditure()" class="d-flex flex-column justify-content-between mt-2 ms-2 h-100">
          <div class="form-row mt-3">
            ...
            <div class="col-lg-3 me-3">
              ...
              <input type="text" name="OtherExp_AccNum" id="" class="form-control" placeholder="022654" v-model="data.exp_ORNum">
            </div>
            <div class="col-lg-3 me-3">
          ...
          <div class="form-row mt-2">
            <div class="col-lg-4 me-1">
              ...
              <select class="form-select" @change="setExpenseType($event)">
          ...
          <div class="form-row mt-2">
            <div class="col-lg-4 me-1">
              ...
              <input type="date" class="form-control" v-model="data.exp_dateFrom">
            </div>
            <div class="col-lg-4 me-1">
              <label class="form-label me-4">To:</label>
              <input type="date" class="form-control" v-model="data.exp_dateTo">
            </div>
          </div>
          <div class="form-row mt-2">
            <div class="col-lg-3">
            ...
            <div v-if="data.exp_paymentType == 'Bank'" class="col-lg-3">
              ...
              <input type="text" class="form-control" v-model="data.exp_bankName">
            </div>
            <div class="col-lg-3">
              <label class="form-label me-4">Account Number</label>
              <input type="text" class="form-control" v-model="data.exp_accNum">
            </div>
            <div class="col-lg-3">
              <label class="form-label me-4">Account Name</label>
              <input type="text" class="form-control" v-model="data.exp_accName">
            </div>
          </div>
          <div class="form-row mt-2">
            <div class="col-md-5">
              <label class="form-label me-4">Amount</label>
              <input type="number" class="form-control" v-model="data.exp_amount">
            </div>
            <div class="col-md-5">
              <label class="form-label me-4">Remarks</label>
              <input type="text" class="form-control" v-model="data.exp_remark">
            </div>
          </div>
          <div class="btn-toolbar pt-2">
            <div class="btn-group me-3 mt-3">
              <button type="submit" class="btn btn-success" style="width:150px; height: 40px;">Add to Project</button>
            </div>           
        </div>
        </form>
      </div>      
...
export default {
    ...
    computed: {
      ...mapGetters(['getExpenditures', 'getProjectCommenceDate']),  
    }
}
</script>
