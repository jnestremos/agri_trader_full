    ...
    <div class="PurchaseOrderDashboard">
        <div class="container-fluid w-100 d-flex pe-5 justify-content-between align-items-center" style="height:10%; background-color: #E0EDCA;">
            ...
            <div class="d-flex">                
                ...
                <router-link to="/reports/spo"><button class="btn btn-info text-right me-3">See All Orders</button></router-link>
                <router-link to="/supplyOrder/refunds"><button class="btn btn-info text-right me-3">See Refunds</button></router-link>
                <router-link to="/reports/supplyOrderReturns"><button class="btn btn-info text-right">See Purchase Returns</button></router-link>                
            </div>            
        </div>
                        ...
                        <div class="col-4" v-for="(o, i) in order" :key="i">
                            <div class="card mt-3 ms-3" style="height: 90%; background-color: #E0EDCA; border-radius: 20px;">
                                <div class="card-body" style="position:relative">
                                    ...
                                    <label class="card-title font-weight-bold">{{ `Purchase Order No. ${o.purchaseOrder_num}` }}</label> <!-- name of supply -->
                                            ...
                                            <div class="w-100 mt-5">
                                                ...
                                                controls indicators background="#ababab" style="text-shadow: 1px 1px 2px #333; width:100%; height:100%;">                                                
                                                    <b-carousel-slide v-for="(image, index) in getImages(o)" :key="index" style="height:30vh;">
                                                        <template #img>
                                                            <img class="d-block img-fluid w-100" style="width:100%; height:100%; object-fit:contain" :src="getPODashboard.purchaseOrder_accs && image ? require(`../../../../../public/storage/proof_of_payments/${image}`) : ''">
                                                        </template>                                                        
                                                    </b-carousel-slide>                                                             
                                                </b-carousel>                                                
                                            </div>
